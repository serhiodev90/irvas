...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        requiredInput = document.querySelectorAll('.popup_calc input[required]'),
        checkInput = document.querySelectorAll('.popup_calc_profile .checkbox'),
        furtherBtn = document.querySelectorAll('[data-further]'),
        formEnd = document.querySelector('[data-calc="end"]'),
        scroll = calcScroll();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (item == furtherBtn[0] && (requiredInput[0].value == '' || requiredInput[1].value == '')) {
          console.log('заполни поля!');
        } else if (item == furtherBtn[1] && checkInput[0].checked == false && checkInput[1].checked == false) {
          console.log('выбери профиль!');
        } else {
    ...
    formEnd.addEventListener('submit', function () {
      setTimeout(function () {
        windows.forEach(function (item) {
          item.style.display = 'none';
        });
